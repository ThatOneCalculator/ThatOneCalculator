...
<p align="center">
  ...
  <br>
	<a href="https://t1c.dev">
		<img src="https://skillicons.dev/icons?i=bash,c,css,git,haxe,html,java,js,jquery,latex,linux,md,mongodb,nextjs,nginx,nodejs,postgres,prisma,py,r,react,redis,regex,remix,rust,solidity,svelte,ts,vim" alt="Skills: bash,c,css,git,haxe,html,java,js,jquery,latex,linux,md,mongodb,nextjs,nginx,nodejs,postgres,prisma,py,r,react,redis,regex,remix,rust,solidity,svelte,ts,vim"/>
	</a>
  <!--
